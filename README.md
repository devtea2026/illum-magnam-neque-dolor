# @devtea2026/illum-magnam-neque-dolor

[![Build Status](https://secure.travis-ci.org/nathanboktae/@devtea2026/illum-magnam-neque-dolor.png)](http://travis-ci.org/nathanboktae/@devtea2026/illum-magnam-neque-dolor)

@devtea2026/illum-magnam-neque-dolor is an extension to the [chai](http://chaijs.com/) assertion library that
...
```
npm install @devtea2026/illum-magnam-neque-dolor
```

### bower

```
bower install @devtea2026/illum-magnam-neque-dolor
```
...
chai.use(require('@devtea2026/illum-magnam-neque-dolor'))
```

### AMD

```javascript
require(['chai', '@devtea2026/illum-magnam-neque-dolor'], function(chai, chaiDom) {
  chai.use(chaiDom)
})
```
...
<script src="@devtea2026/illum-magnam-neque-dolor.js"></script>
```
